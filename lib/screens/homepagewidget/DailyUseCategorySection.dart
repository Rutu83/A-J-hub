...
class DailyUseCategorySection extends StatefulWidget {
  ...
  State<DailyUseCategorySection> createState() =>
      _DailyUseCategorySectionState();
}

class _DailyUseCategorySectionState extends State<DailyUseCategorySection>
  ...
  Future<List<DaillyCategory>> fetchDailyItems() async {
    final response =
        await getDailyUseWithSubcategory(); // returns DaillyuseResponse
  ...
  Widget build(BuildContext context) {
    ...
    if (cacheddaillyusecategory != null &&
        cacheddaillyusecategory!.isNotEmpty) {
      initialData = cacheddaillyusecategory!.first.subcategories;
    }
  ...
  Widget _buildGrid(List<DaillyCategory> items) {
    // Dynamic column count: 6 for tablets, 4 for phones
