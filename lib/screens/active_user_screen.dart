...
class ActiveUserPageState extends State<ActiveUserPage> {
  final TextEditingController amountController =
      TextEditingController(text: '599');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  responseData['message'] ?? 'User activated successfully!')),
        );
      } else {
        ...
        if (errorData['error'] is Map) {
          ...
          final firstErrorValue =
              (errorData['error'][firstErrorKey] as List).first;
                                          ...
                                          builder: (context, setState) {
                                            ...
                                            return Container(
                                              ...
                                              padding: MediaQuery.of(context)
                                                  .viewInsets, // Adjust for the keyboard
                                                        ...
                                                        itemBuilder:
                                                          ...
                                                          return Container(
                                                            ...
                                                            decoration:
                                                              ...
                                                              border: Border.all(
                                                                  color: Colors
                                                                      .grey), // Gray border for each user item
                                                              borderRadius:
                                                                  BorderRadius
                                                                      .circular(
                                                                          10), // Rounded corners
            ...
            ElevatedButton(
              onPressed: () {
                ...
                if (adminPassword.isEmpty) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                        content: Text('Admin password is required.')),
                  );
                } else {
