...
import '../../model/daillyuse_modal.dart';
import '../../network/rest_apis.dart';
import '../../utils/shimmer/shimmer.dart';

class DirectSellingBlogCategorySection extends StatefulWidget {
  const DirectSellingBlogCategorySection({super.key});

  @override
  State<DirectSellingBlogCategorySection> createState() =>
      _DirectSellingBlogCategorySectionState();
}

class _DirectSellingBlogCategorySectionState
    extends State<DirectSellingBlogCategorySection>
    with AutomaticKeepAliveClientMixin {
  late Future<List<DaillyCategory>> _dailyItems;
  ...
  void initState() {
    super.initState();
    _dailyItems = fetchDailyItems();
  }

  Future<List<DaillyCategory>> fetchDailyItems() async {
    final response =
        await getdirectsellingUseWithSubcategory(); // returns DaillyuseResponse
  ...
  Widget build(BuildContext context) {
    ...
    List<DaillyCategory>? initialData;
    if (cachedDirectSellingSubcategory != null &&
        cachedDirectSellingSubcategory!.isNotEmpty) {
      initialData = cachedDirectSellingSubcategory!.first.subcategories;
    }

    return FutureBuilder<List<DaillyCategory>>(
  ...
  Widget _buildGrid(List<DaillyCategory> items) {
